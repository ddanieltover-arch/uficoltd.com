...
- Public contact → Inquiry; product enquiry → QuoteRequest; both still send Resend email after spam checks and Cloudflare Turnstile siteverify (`TURNSTILE_SECRET`, actions `contact` / `enquiry`)
