...
export const emailConfig = {
  ...
  salesEmail: process.env.RESEND_TO_EMAIL ?? process.env.SMTP_TO_EMAIL ?? "sales@uficoltd.com",
  fromEmail: resolveFromEmail(),
  fromName: process.env.RESEND_FROM_NAME ?? process.env.SMTP_FROM_NAME ?? "UFI Co., LTD",
  phone: "+(66) 2656 8481",
